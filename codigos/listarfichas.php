...
$comando2 = mysql_query("SELECT id FROM agendamento ORDER BY id");
...
<div class="container" role="main">
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div class="well">Listar fichas de solicitações</div>
			...
			<table class="table table-hover table-bordered table-striped">
				...
				?>
						<tr>
							...
							<td><?php echo $atributo['turno']; ?></td>
							<td><?php echo $atributo['turma']; ?></td>
							<td><?php echo $atributo['servico']; ?></td>
							<td style="color: green"><?php echo $atributo['confirma']; ?></td>
							
							<td>
								<a href="?tipo=ficha&acao=nova&id=<?php echo $atributo['id']; ?>" type="button" onclick="return confirm('Deseja cadastrar um horário para este cliente?');" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-plus"></span></a>
					...
					<?php 
						for($i=1; $i <= $total_paginas; $i++){
							if($pagina == $i){
								...
								echo "<li><a href=\"?tipo=ficha&acao=listar&pag=".$i."\">".$i."</a></li>";
							}
						}
					?>
				</ul>
